...
grant usage on schema traffic_intelligence_db.dbt_dev_gold to role data_analyst;

grant select, insert, update, delete on all tables in schema traffic_intelligence_db.dbt_dev_silver to role developer;
grant select on all tables in schema traffic_intelligence_db.dbt_dev_gold to role data_analyst;

grant select on future tables in schema traffic_intelligence_db.dbt_dev_gold to role data_analyst;